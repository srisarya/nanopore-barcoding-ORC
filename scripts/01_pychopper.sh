...
primer_seqs=Lakes_meiofauna_workshop/adapters_hmms/M13_seqs_for_pychopper.fa # primer sequences plus N wildcards for variable section
config=Lakes_meiofauna_workshop/adapters_hmms/M13_config_for_pychopper.txt # configuration file for sequence orientation
