...
primer_seqs=../adapters_hmms/M13_seqs_for_pychopper.fa # primer sequences plus N wildcards for variable section
config=../adapters_hmms/M13_config_for_pychopper.txt # configuration file for sequence orientation
