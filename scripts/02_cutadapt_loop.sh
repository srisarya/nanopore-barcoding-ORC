#!/bin/bash
#SBATCH --job-name=cutadapt_manual
#SBATCH --mem=4G
...
adapters_SP5=../adapters_hmms/M13_amplicon_indices_forward.fa
adapters_SP27=../adapters_hmms/M13_amplicon_indices_reverse_rc.fa
